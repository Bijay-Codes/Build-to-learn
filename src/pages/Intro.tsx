export default function Intro() {
    return (
        <section className="flex flex-col gap-8">
            <h1 className="text-4xl">Why was this Repo made?</h1>
            <h2 className="text-xl">I am also kind of clueless why, but the general answer is i wanted to build something to learn</h2>
